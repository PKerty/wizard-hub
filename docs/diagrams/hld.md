...
flowchart LR
    ...
    subgraph App["wizard-hub app"]
        ...
        ANA["analytics wrapper<br/>lib/analytics<br/>(ADR-0006 / 0017)"]
...
| Estructura | App Router + Houses module hexagonal — [ADR-0009](../adr/0009-estructura-app-router-hexagonal-ddd.md) |
| Analytics | Wrapper propio sobre `@amplitude/unified` — [ADR-0006](../adr/0006-amplitude-wrapper-tipado.md), [ADR-0017](../adr/0017-migracion-amplitude-unified.md) |
