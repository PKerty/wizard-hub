    ...
    <section className="mt-16 border-t border-moonlight/20 pt-12">
      ...
      <div className="mt-6">
        <Link
          ...
          className="btn-primary inline-flex w-full items-center justify-center gap-2 rounded-soft bg-torchlight px-6 py-3 font-display text-eyebrow uppercase tracking-[0.2em] text-bg-void transition-all duration-base ease-arcane hover:brightness-110 sm:w-auto"
        >
          Join the Order
        </Link>
      </div>
